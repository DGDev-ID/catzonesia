...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Service Category', href: '/service/category' }];
...
<template>
    <Head title="Service Category" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="min-h-screen bg-muted/40 py-10">
            <div class="mx-auto max-w-7xl space-y-8 px-6">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <HeadingSmall title="Service Category" description="Kelola daftar kategori service." />
                    <Link
                        :href="route('service.category.create')"
                ...
                <PaginatedTable :headers="headers" :paginator="categories">
                    <template #cell-actions="{ item }">
                        <div class="flex justify-end items-center gap-3">
                            <Link
                                :href="route('service.category.edit', { category: item.id })"
                            ...
                            <Link
                                :href="route('service.category.destroy', { category: item.id })"
                                method="delete"
                                as="button"
                                preserve-scroll
