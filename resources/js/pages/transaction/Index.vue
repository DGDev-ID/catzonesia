                ...
                <div class="rounded-2xl border bg-background shadow-sm p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="date_from" v-model="dateFrom" type="date" lang="id-ID"
                        ...
                        <div>
                            ...
                            <input id="date_to" v-model="dateTo" type="date" lang="id-ID"
                                class="w-full px-3 py-2 text-sm rounded-xl border bg-background focus:outline-none focus:ring-2 focus:ring-ring" />
                        </div>
                    </div>
                    <div class="mt-4 flex justify-end">
                        <button type="button" @click="filterTransactions"
                    ...
                    <PaginatedTable :headers="headers" :paginator="transactions">
                        <template #cell-actions="{ item }">
                            <div class="flex justify-end">
                                <button type="button" @click="viewTransaction(item.id)"
