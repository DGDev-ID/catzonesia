...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah', href: '/user-management/role/create' },
];
...
const submit = () => {
    form.post('/user-management/role', { preserveScroll: true });
};
</script>
        ...
        <div class="min-h-screen bg-muted/40 py-10">
            <div class="mx-auto max-w-7xl space-y-8 px-6">
                ...
                <div class="flex items-center justify-between">
                    <Heading variant="small" title="Tambah Role" description="Buat role baru dan tentukan hak aksesnya." />
